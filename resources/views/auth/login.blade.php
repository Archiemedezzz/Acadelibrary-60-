        ...
        <form action="{{ route('login') }}" method="POST" class="flex flex-col w-full">
            ...
            <div class="flex items-center justify-between mt-2 mb-8">
                <label class="flex items-center gap-3 cursor-pointer select-none">
                    ...
                    <div
                        class="w-4 h-4 border border-[#555] rounded-sm transition-all duration-200 peer-checked:border-white relative after:absolute after:inset-1 after:bg-white after:scale-0 after:transition-transform after:duration-200 peer-checked:after:scale-100">
                    </div>
